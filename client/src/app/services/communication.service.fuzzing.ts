...
describe('CommunicationService Fuzzing', () => {
    ...
    it('getGameFile', async () => {
        ...
        const errors = await fuzz(getGameFile).under(preset.string(), preset.boolean()).errors();
        // console.log(`Errors founds: ${errors.length}`);
        // console.log(errors);
        expect(errors.length).toEqual(0);
    });
    ...
    it('getGames', async () => {
        ...
        const errors = await fuzz(getGames).number().errors();
        // console.log(`Errors founds: ${errors.length}`);
        // console.log(errors);
        expect(errors.length).toEqual(0);
    });
    ...
    it('createGamePost', async () => {
        ...
        //     .under(preset.string(), preset.string(), preset.string(), [], preset.string(), preset.number(), preset.boolean())
        //     .errors();
        // console.log(`Errors founds: ${errors.length}`);
        // console.log(errors);
        const errors = [];
