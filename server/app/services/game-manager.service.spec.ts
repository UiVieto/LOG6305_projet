...
import { BEST_TIME_PLACEHOLDER, GAME_CONSTANTS, SECONDS_TO_MILLISECONDS } from '@app/constants/constants';
...
describe('GameManager service tests', () => {
    ...
    it('resetGameBestTimes should reset the best times', (done) => {
